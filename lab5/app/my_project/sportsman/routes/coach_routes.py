...
@swag_from('lab5/app/my_project/sportsman/swagger.yaml', methods=['GET'])
def get_coach():
...
@swag_from('lab5/app/my_project/sportsman/swagger.yaml', methods=['POST'])
def add_coach():
